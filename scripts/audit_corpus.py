...
from src.attach_images import extract_image_refs, body_expects_attached_figure
from src.catalog import is_catalog_eligible
from src.paths import PipelinePaths
from src.record_store import load_jsonl
from src.repair_images import needs_image_repair
from src.vision_repair import needs_vision_image_repair
...
def audit(paths: PipelinePaths) -> dict:
    ...
    shared_assets = {path: ids for path, ids in asset_dupes.items() if len(ids) > 1}
